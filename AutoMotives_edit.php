...
<?php
    $x = $_GET['data'];
        ...
        $qr2 = "select * from motives where ID='$x'";
...
?>
    <!-- <form action="update.php" class="form" method="post">
        <p><h2>AUTO-MOTIVES EDIT FORM</h2></p>
        <p>NAME / DESCRIPTION: <input type="text" name="Name" ></p>
        <p>ASSET ID:    <input type="text" name="ID" ></p>        
        <p>PLACE OF DEPLOYMENT: <input type="text" name="Place_of_deployment" ></p>
        <p>Deployed Department: <input type="text" name="Department" id="" ></p>
        <p>Person Incharge: <input type="text" name="PersonIncharge" id=""></p>
        <p>Person ID: <input type="text" name="PersonId" id="" ></p>
        <p>Contact: <input type="text" name="Contact" id="" ></p>  
        <label>Date OF ACQUISITION : <input type="text" name="Date"></label>
        <br> <br>
