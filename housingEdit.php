...
<div class="container">
    <form action="update.php" method="post">
        ...
        <div class="content">
            ...
            <div class="input_box">
                <label>House Id: <input  type="text" name="HousingId"  value="<?php  echo $row['HousingId']?>" required></label>
            </div>
            <div class="input_box">
                    <lable>Housing Purpose:     
                        <select  id="" name="HousePurpose">
            ...
            <div class="input_box">
                <label>DATE OF ACQUISITION : <input type="text" name="DateOfCreaton"  value="<?php echo $row['DateOfCreaton']?>" required></label>
            </div>
            <div class="input_box" >
                <label>STATUS   
